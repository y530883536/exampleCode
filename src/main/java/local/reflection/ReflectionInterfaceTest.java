...
public class ReflectionInterfaceTest {
    public static void main(String[] args) throws Exception{
        ...
        //Class<TestInterfaceOne> testInterfaceClass = TestInterfaceOne.class;
        //TestInterfaceOne testInterface = testInterfaceClass.getConstructor().newInstance();
